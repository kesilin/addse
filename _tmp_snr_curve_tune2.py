...
run_name = 'nhfae_e1_interact_tune2'
root = Path('outputs/phase6/controlled_snr_test31/snr_10_15')
clean_dir = root / 'clean'
noisy_dir = root / 'noisy'
pred_dir = Path(f'outputs/phase9/{run_name}/wav')
out_dir = Path(f'outputs/phase9/{run_name}')
...
plt.title('E1+ Interact tune2: SNR vs delta SDR')
plt.legend()
plt.tight_layout()
